        ...
        <TooltipProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/services/iso42001" element={<ISO42001 />} />
              <Route path="/services/dpo-service" element={<DPOService />} />
              <Route path="/services/microsoft-copilot" element={<MicrosoftCopilot />} />
              <Route path="/news/ai-wiapc-framework" element={<AIWIAPCAFramework />} />
              <Route path="/news/iso42001-game-changer" element={<ISO42001GameChanger />} />
              ...
              <Route path="/news/openai-agentic-ai" element={<OpenAIAgenticAI />} />
              <Route path="/news/microsoft-copilot-agentic" element={<MicrosoftCopilotAgentic />} />
              <Route path="/news/google-agent-spaces" element={<GoogleAgentSpaces />} />
              <Route path="/news/agentic-ai-enterprise-adoption" element={<AgenticAIEnterpriseAdoption />} />
              <Route path="/news/agentic-ai-governance" element={<AgenticAIGovernance />} />
